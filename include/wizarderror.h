...
/**
* To Do
* assert -> debug == 1 ?ï¿½ï¿½?ï¿? using #if, #endif
* and throw..!!
*/
// cf) using function call
template <typename T>
void assertEquals(std::string message, T expected, T actual );
template <typename T>
 void assertEquals( T expected, T actual );
template <typename T>
 void assertNotEquals( T expected, T actual );
 void assertTrue(std::string message, bool expected );
 void assertTrue(std::string message, int expected );
 void assertTrue( bool expected );
 void assertTrue( int expected );
 void assertFalse(std::string message, bool expected );
 void assertFalse(std::string message, int expected );
 void assertFalse( bool expected );
 void assertFalse( int expected );

/// of course,  below T are Pointer Type !!!
template <typename T> // pointer ï¿?.
 void assertNULL(std::string message, T expected  );
template <typename T> // pointer ï¿?.
 void assertNULL( T expected  );
template <typename T>
 void assertNotNULL(std::string message, T expected );
template <typename T>
...
template <typename T>
inline void assertEquals(std::string message, T expected, T actual ){
    if( expected == actual ){
    }
    else{
...
template <typename T>
inline void assertNotEquals(std::string message, T expected, T actual ){
    if( expected != actual ){
    }
    else{
...
inline void assertTrue(std::string message, bool expected ){
    if( expected ){
    }
    else{
        throw AssertFail( message );
...
inline void assertTrue(std::string message, int expected ){
    if( expected ){
    }
    else{
        throw AssertFail( message );
...
inline void assertFalse(std::string message, bool expected )
{
    if( !expected ){
    }
    else{
...
inline void assertFalse(std::string message, int expected )
{
    if( !expected ){
    }
    else{
...
/// of course,  below T are Pointer Type !!!
template <typename T> // pointer ï¿?.
inline void assertNULL(std::string message, T expected  ){
    if( expected == NULL ){
    }
    else{
        throw AssertFail( message );
...
template <typename T>
inline void assertNotNULL(std::string message, T expected ){
    if( expected != NULL ){
